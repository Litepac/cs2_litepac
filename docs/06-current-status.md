...
- Smoke replay truth includes its trajectory, detonation center, active/end ticks, and parser-derived HE displacement window, but not CS2's dynamic collision-aware volume. The 2D viewer therefore uses a quiet neutral screen-space occlusion field with no exact-boundary, team-ownership, or countdown-ring claim.
